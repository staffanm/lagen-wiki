...
Du kan länka till enskilda dokument, och även till enskilda paragrafer och artiklar inuti dem. För att länka till lagen om elektronisk kommunikation (LEK), som har SFS-nummer 2022:482, använder du följande address:
...
Samma mönster -- prefixet följt av dokumentets egen beteckning -- gäller för alla dokumenttyper:

- **Lag / förordning (SFS):** `https://lagen.nu/<SFS-nummer>`, t.ex. `https://lagen.nu/2022:482`
- **Myndighetsföreskrift:** `https://lagen.nu/<samling>/<nummer>`, t.ex. `https://lagen.nu/afs/1981:14`
...
```
https://lagen.nu/<SFS-nummer>[#K<kapitel>][P<paragraf>]
```
...
länk du sätter idag fungerar även när lagen ändras -- och när en lag upphävs
ligger den kvar och går fortfarande att nå på sin adress, märkt som upphävd. Du
behöver aldrig fråga om lov för att länka hit.
