...
Turordningsregler tillämpas endast vid [arbetsbrist arbetsbristuppsägningar](begrepp:arbetsbrist arbetsbristuppsägningar). Dessa regler kan dock åsidosättas genom [kollektivavtal](begrepp:kollektivavtal) då paragrafen i sin lydelse är [semidispositiv](begrepp:semidispositiv).

Huvudregeln är att den som senast blev anställd ska vara den förste som får gå vid en [arbetsbrist arbetsbristuppsägningar](begrepp:arbetsbrist arbetsbristuppsägningar). Om en arbetsgivare har högst tio anställda kan två nyckelpersoner undantas från turordningen. Dessa väljs av arbetsgivaren som dock måste motivera att dessa två personer är av särskild betydelse för den fortsatta verksamheten.
