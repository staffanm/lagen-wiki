...
Detta är ett avsteg från det [första avtalets princip](begrepp:första avtalets princip) och har av EG-domstolen funnits vara direkt diskriminerande i [Lavalmålet](http://curia.europa.eu/jcms/upload/docs/application/pdf/2009-02/cp070098sv.pdf), (EG-domstolen C-341/05).
