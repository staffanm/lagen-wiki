...
Det här är ett exempel på en [insynsrätt](begrepp:insynsrätt), dvs en rätt för den enskilde att få insyn i vad myndigheter och företag har lagrat för information. Andra exempel på insynsrätter är [offentlighetsprincipen](begrepp:offentlighetsprincipen) och [partsinsyn](begrepp:partsinsyn) (som i första hand gäller mot myndigheter).
