...
PUL kompletteras av [personuppgiftsförordningen (PUF)](begrepp:SFS/1998:1191) och [datainspektionens föreskrifter (DIFS)](http://www.datainspektionen.se/lagar-och-regler/datainspektionens-foreskrifter/). Härutöver gäller även ett stort antal [registerförfattning](begrepp:registerförfattning)ar, exempelvis [förordningen (2001:640) om registerföring m.m. vid länsrätt med hjälp av automatiserad behandling](begrepp:SFS/2001:640). Även [europakonventionen](begrepp:europakonventionen)s artikel 8 (rätt till privatliv) reglerar den personliga integriten.

På EU-nivå finns ett förslag till dataskyddsförordning.
