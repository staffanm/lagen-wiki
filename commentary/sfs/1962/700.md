...
Hackning, spridande av virus, DOS/DDOS-attacker samt vanligt spam utgör några av brotten enligt denna paragraf så länge som angreppet innebär att systemet utsätts för ett olaga intrång , det krävs inte att man bryter sig in utan det kan vara ett öppet system utan verifieringssystem. En som använder ett sådant öppet system olovligen begår ett dataintrång enligt paragrafen. Till undantaget hör att någon sänker en e-post server genom att spamma den. 
