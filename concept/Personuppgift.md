...
Personuppgiftslagen (och dataskyddsdirektivet) skrevs i första hand för att skydda enskilda mot att deras integritet kränks genom insamling av omfattande och/eller känsliga uppgifter i datoriserade register. Sådana register utmärks av att man lätt kan få fram all information som gäller en viss person, eller kan samköra uppgifter i två eller flera register för att göra informationssammanställningar om en viss person. För att få ha ett sådant register måste den [personuppgiftsansvarig](begrepp:personuppgiftsansvarig)e se till att följa ett ganska omfattande regelverk (den s.k. [hanteringsmodellen](begrepp:hanteringsmodellen).

I många sammanhang förekommer personuppgiter som inte är strukturerade på ett sånt sätt att det lätt går att sammanställa eller söka fram uppgifter om en enskild person - exempelvis omnämnande i löpande text, digitalfotografier på en person, eller digitala ljud- och videoinspelningar. För att hantera sådana ostrukturerade personuppgifter behöver den personuppgiftsansvarige bara följa en enklare reglering (den s.k. [missbruksmodellen](begrepp:missbruksmodellen)).
