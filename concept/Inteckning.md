...
categories:
  - Fastighetsrätt
---
[Inskrivning](begrepp:Inskrivning) av ett visst belopp i fastigheten. Som bevis på inteckningen skapas ett [pantbrev](begrepp:pantbrev) som kan användas som [säkerhet](begrepp:säkerhetsrätt) för en [fordran](begrepp:fordran).
...
Lantmäteriet: ["Inskrivning - Inteckning och pantbrev"](http://www.lantmateriet.se/templates/LMV_FaqList.aspx?id=15369)
